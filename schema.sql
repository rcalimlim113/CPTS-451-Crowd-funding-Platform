...
insert into USERS
values (1, 'John', 'Smith', 'johnS@gmail.com', 'password1234', 'user', '123-456-7890',CURRENT_TIMESTAMP,TRUE);
insert into USERS values (2, 'Alex', 'Bones', 'AlexB@gmail.com', '123456789', 'user', '598-123-4512',CURRENT_TIMESTAMP,TRUE);
ALTER TABLE USERS MODIFY USER_ID GENERATED ALWAYS AS IDENTITY;

select * from users

ALTER TABLE CAMPAIGNS MODIFY CAMPAIGN_ID GENERATED BY DEFAULT AS IDENTITY;
insert into CAMPAIGNS
values (1, 1, 'Help my Cat!', 'My cat needs help, anything helps!', 1000.95, DATE '2026-01-01', DATE '2027-01-01', 'active', TRUE, CURRENT_TIMESTAMP);
ALTER TABLE CAMPAIGNS MODIFY CAMPAIGN_ID GENERATED ALWAYS AS IDENTITY;
